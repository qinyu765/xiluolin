...
| T030 | P0 | 加固本地凭据和隐私数据处理 | 将 API Key 迁移到系统凭据库，清理敏感日志，并限制和清理应用录音临时文件 | Review | main | 不适用（main 直提） | `pnpm check`、凭据迁移测试、录音路径与清理测试、Windows CI | [2026-07-17-t030-credential-privacy-hardening.md](./2026-07-17-t030-credential-privacy-hardening.md) | 本地完整检查通过；等待提交并确认 Windows CI |
