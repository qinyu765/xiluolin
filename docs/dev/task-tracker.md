...
| T006 | P0 | 实现智谱 GLM-ASR-2512 Provider | 直接在 `dev` 上支持配置 API Key、Base URL、模型名，输入短音频文件并输出原始识别文本 | Review | dev | 待创建 | 假配置错误验证；真实本地配置端到端验证 | [2026-05-24-t006-zhipu-asr-provider.md](./2026-05-24-t006-zhipu-asr-provider.md) | ASR 失败不写入历史 |
