...
| T007 | P0 | 实现 OpenAI Responses API 文本整理 | 直接在 `dev` 上输入原始识别文本、当前人格 prompt、热词上下文，输出整理后的可用文本 | Review | dev | 待创建 | 假配置错误验证；真实本地配置端到端验证 | [2026-05-24-t007-openai-responses-text-polish.md](./2026-05-24-t007-openai-responses-text-polish.md) | 整理失败时保留原文 |
