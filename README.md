...
当前仓库已接入 OpenAI Responses API 文本整理 Provider，可保存本地 OpenAI 配置，并根据人格提示词与热词上下文整理原始识别文本。
...
- 本次已建立桌面应用骨架、本地数据层、智谱 ASR Provider 和 OpenAI 文本整理 Provider，但仍不包含完整语音输入业务流程。
- 第三方依赖用途：
